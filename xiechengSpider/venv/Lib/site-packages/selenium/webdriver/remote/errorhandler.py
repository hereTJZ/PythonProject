...
from seleniumUsage.common.exceptions import (ElementClickInterceptedException,
...
class ErrorCode(object):
    ...
    """
    # Keep in sync with org.openqa.seleniumUsage.remote.ErrorCodes and errorcodes.h
    SUCCESS = 0
