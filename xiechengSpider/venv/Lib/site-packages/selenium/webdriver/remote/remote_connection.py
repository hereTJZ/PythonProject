...
from seleniumUsage.webdriver.common import utils as common_utils
from seleniumUsage import __version__
...
class RemoteConnection(object):
    ...
    def get_remote_connection_headers(cls, parsed_url, keep_alive=False):
        ...
        headers = {
            ...
            'User-Agent': 'seleniumUsage/{} (python {})'.format(__version__, system)
        }
